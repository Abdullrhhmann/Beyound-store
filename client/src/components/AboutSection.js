  ...
  return (
    <section className="section-container bg-transparent pt-0 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.h2 
            className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-bold text-white mb-6 md:mb-8"
          >
            
          </motion.h2>
          
          <motion.p 
            className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-100 mb-4 md:mb-6 font-medium"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-stretch mb-16 md:mb-24">
          {/* Our Story Card - Slides in from left */}
          <motion.div 
          ...
          {/* CEO Image Card - Slides in from center */}
          <motion.div 
          ...
          {/* The Problem Card - Slides in from right */}
          <motion.div 
        ...
        {/* Mission Statement - Slides in from left */}
        <motion.div 
        ...
        >
          ...
          <p className="text-lg md:text-xl lg:text-2xl leading-relaxed max-w-4xl mx-auto">
            To Empower. To Include. To <span className="font-bold">BEYOUND</span>.
          </p>
          <p className="text-base md:text-lg text-gray-300 mt-4 md:mt-6 max-w-3xl mx-auto">
            We exist to empower individuals with disabilities by designing fashion that adapts to their needs, not the other way around. Our mission is rooted in sustainability, social inclusion, and community-driven innovation.
          </p>
        </motion.div>

        {/* Stats Section - Individual triggers for each stat */}
        ...
        {/* Values Section - Individual triggers */}
        <div className="mb-24">
          <motion.h3 
